...
import { memos as mockMemos } from '@/data/mock';
...
export function MemoReferencePicker({ onSelect, selectedIds }: MemoReferencePickerProps) {
    ...
    <Popover>
      ...
      <PopoverContent className="w-80 p-2" align="start">
        ...
        <div className="max-h-48 overflow-auto space-y-1">
          {filtered.length === 0 ? (
            <p className="text-xs text-muted-foreground text-center py-3">No memos found</p>
          ) : (
