...
import {
  Eye, CheckCircle2, ThumbsUp, MessageCircle,
  Smile,
} from 'lucide-react';
      ...
      <div className="grid grid-cols-4 gap-4 mb-5">
        <div className="space-y-1">
          <div className="flex items-center justify-between text-xs">
            ...
            <span className="font-medium">{opened}/{total}</span>
          </div>
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-xs">
            ...
            <span className="font-medium">{ack}/{total}</span>
          </div>
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-xs">
            ...
            <span className="font-medium">{replied}/{total}</span>
          </div>
