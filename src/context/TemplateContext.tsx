...
interface TemplateContextType {
  ...
  addTemplate: (template: Omit<MemoTemplate, 'id' | 'createdAt' | 'isBuiltIn' | 'createdBy'>) => void;
...
export function TemplateProvider({ children }: { children: React.ReactNode }) {
  ...
  const addTemplate = useCallback((data: Omit<MemoTemplate, 'id' | 'createdAt' | 'isBuiltIn' | 'createdBy'>) => {
  ...
  return (
    <TemplateContext.Provider value={{ templates, addTemplate, deleteTemplate, getTemplateById }}>
      {children}
